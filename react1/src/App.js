...
class App extends Component {
  ...
  render() {
    return (
      //--------------------------------------------------------------------
      //modul step pertama - menambahkan style css
      // <div className="App">
      //   <h3 className="judul">Ini Project Pertama React</h3>
      //   <p className="subJudul">Belajar React JS itu mudah</p>
      // </div>
      //--------------------------------------------------------------------

      //--------------------------------------------------------------------
      //modul step kedua - penggunaan bootstrap
      // <div className="App container">
      //   <div className="alert alert-info">
      //     <h3 className="text-danger">Ini Project Pertama React JS</h3>
      //     <p>Belaj ar React JS itu mudah</p>
      ...
      //--------------------------------------------------------------------
      //modul step ketiga - menggunakan custom elements
      ...
      //--------------------------------------------------------------------
      //modul step empat- membuat custom elemen menggunakan props
      // <div className="App container col-sm-6">
      ...
      //--------------------------------------------------------------------
      //modul step empat- membuat custom elemen menggunakan props #2
      // <div className="App container col-sm-6">
      ...
      //--------------------------------------------------------------------
      //pembuatan elemen dengan props dan state
      <div className="App container col-sm-6">
